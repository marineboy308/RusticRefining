...
public class GuiBlockCell extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		this.drawTexturedModalRect(this.guiLeft + 57, this.guiTop + 22 + 16 - j, 176, 16 - j, 13, j + 1);
		int i = this.getEnergyScaled(17,2,3);
		this.drawTexturedModalRect(this.guiLeft + 106, this.guiTop + 22 + 16 - i, 176, 16 - i, 13, i + 1);
		int k = this.getEnergyScaled(17,4,5);
		this.drawTexturedModalRect(this.guiLeft + 57, this.guiTop + 40 + 16 - k, 176, 16 - k, 13, k + 1);
		int l = this.getEnergyScaled(17,6,7);
		this.drawTexturedModalRect(this.guiLeft + 106, this.guiTop + 40 + 16 - l, 176, 16 - l, 13, l + 1);
		int h = this.getEnergyScaled(17,8,9);
		this.drawTexturedModalRect(this.guiLeft + 57, this.guiTop + 58 + 16 - h, 176, 16 - h, 13, h + 1);
		int g = this.getEnergyScaled(17,10,11);
		this.drawTexturedModalRect(this.guiLeft + 106, this.guiTop + 58 + 16 - g, 176, 16 - g, 13, g + 1);
	}
