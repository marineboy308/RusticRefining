...
public class BlockInit {
	...
	//Ores
	public static final Block ORE_COPPER = new BlockOre("ore_copper",Material.ROCK,SoundType.STONE,3.0F,15.0F,true);
	public static final Block ORE_COPPER_OXIDIZED = new BlockBase("ore_copper_oxidized",Material.ROCK,SoundType.STONE,2.0F,10.0F);
	public static final Block ORE_MAGNESIUM = new BlockOre("ore_magnesium",Material.ROCK,SoundType.STONE,3.0F,15.0F,false);
